...
We maken bij `CustomerControllerIntegrationTest.java` een mock van de service: `private CustomerService service;`, dit betekent dat de service een voorgeprogrammeerde response terugkrijgt.
